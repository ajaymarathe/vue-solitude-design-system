                        ...
                        <div class="heading text-center">
                            ...
                            <div>
                                <a target="_blank" href="http://blog.bootcatch.com/post/vue-components-based-design-system-is-based-on-bootcatch-themes-and-vue" class="text-decoration-none">
                                 ...
                                 <a class="text-decoration-none" href="https://github.com/ajaymarathe/vue-solitude-design-system/archive/master.zip" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <base-card class="border-primary">
                                        <card-header class="border-bottom border-primary bg-transparent">
                                            card-header
                                        </card-header>
                                        <card-body>
                                        ...
                                        <card-footer class="border-primary">
                                           card-footer
                                        </card-footer>
                                    </base-card>
                                </div>
                   ...
                   <div class="row justify-content-center">
                       <div class="col-md-8">
                           <div class="header text-light ">
                               ...
                               <p class="lead mb-4">There are 675 icons in Font Awesome 4.7.0, easy to use. Which look awesome with <span class="text-uppercase">{{ title }}</span>,
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            beautiful documentation to help you out. It is based on <a href="http://www.bootcatch.com/lightly" target="_blank">Solitude Theme</a>. Which is based on latest Bootstrap.</p>
